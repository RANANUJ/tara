...
class EventEnvelope(BaseModel):
    ...
    timestamp: datetime
    type: str = Field(pattern=r"^(session\.(hello|ping|close)|client\.ack|audio\.(session\.(start|stop|cancel)|format|flush)|transcript\.cancel|agent\.(request|cancel)|tts\.cancel)$")
