...
- Remaining M16 work: controlled global/per-owner concurrency, timeout, cancellation, fairness, and broader shutdown/race test coverage; orphan/owner-deletion cleanup tests; full lifecycle/retry policy completion; fresh proposal creation after invalidation; REST/WebSocket transport; frontend task management; scheduler health/status; final documentation; and acceptance. M16 is not complete and no M17 work has started.
