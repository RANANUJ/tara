...
- Remaining M16 work: complete scheduler runtime tests for eligibility, concurrent claiming, cancellation, bounded concurrency, recurrence, and shutdown; a plan-approved safe capability execution payload/reference design; execution lifecycle and retry/recurrence completion; typed updates for currently immutable capability/target/parameter fields; fresh proposal creation after invalidation; bounded orphan-proposal cleanup; REST/WebSocket transport; frontend task management; scheduler health/status; final documentation; and acceptance. M16 is not complete and no M17 work has started.
