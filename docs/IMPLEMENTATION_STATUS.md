...
- Remaining M16 work: orphan/owner-deletion cleanup tests; comprehensive scheduler runtime race, concurrency-limit, timeout, and shutdown coverage; full lifecycle/retry policy completion; fresh proposal creation after invalidation; REST/WebSocket transport; frontend task management; scheduler health/status; final documentation; and acceptance. M16 is not complete and no M17 work has started.
