...
- Remaining M16 work: orphan/owner-deletion cleanup tests; broader scheduler race, global/per-owner concurrency-limit, timeout, cancellation, and shutdown coverage; full lifecycle/retry policy completion; fresh proposal creation after invalidation; REST/WebSocket transport; frontend task management; scheduler health/status; final documentation; and acceptance. M16 is not complete and no M17 work has started.
